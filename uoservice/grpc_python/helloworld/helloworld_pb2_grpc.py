...
class ImageServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessImage = channel.unary_unary(
                '/helloworld.ImageService/ProcessImage',
                request_serializer=helloworld__pb2.ImageRequest.SerializeToString,
                response_deserializer=helloworld__pb2.ImageResponse.FromString,
                )
...
def add_ImageServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ProcessImage': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=helloworld__pb2.ImageResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class ImageService(object):
    ...
    def ProcessImage(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/helloworld.ImageService/ProcessImage',
            helloworld__pb2.ImageRequest.SerializeToString,
            helloworld__pb2.ImageResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
